...
//quietly
streg ma_post_in_1880 border y1880 postrevenues_pc telegraphrevenues_pc agriculture empratio82 indexdissim82 statetax railstation railrevenues participation socialist zentrum difcatholicszentrum city popshare1880 fringe,  vce(robust) distribution(weibull) time    
estimates store WBCons2


//quietly
streg ma_pop_out_1880 border y1880 postrevenues_pc telegraphrevenues_pc agriculture empratio82 indexdissim82 statetax railstation railrevenues participation socialist zentrum difcatholicszentrum city popshare1880 fringe,  vce(robust) distribution(weibull) time    
estimates store WBCons3

//quietly
streg ma_pop_in_1880 border y1880 postrevenues_pc telegraphrevenues_pc agriculture empratio82 indexdissim82 statetax railstation railrevenues participation socialist zentrum difcatholicszentrum city popshare1880 fringe,  vce(robust) distribution(weibull) time    
estimates store WBCons4
...
//quietly 
streg  ma_post_in_1880 border y1880 postrevenues_pc telegraphrevenues_pc agriculture empratio82 indexdissim82 statetax railstation railrevenues participation socialist zentrum difcatholicszentrum city popshare1880 fringe,  vce(robust) strata(region_factor)  distribution(weibull) time    
estimates store WBConsStrata2

//quietly 
streg  ma_pop_out_1880 border y1880 postrevenues_pc telegraphrevenues_pc agriculture empratio82 indexdissim82 statetax railstation railrevenues participation socialist zentrum difcatholicszentrum city popshare1880 fringe,  vce(robust) strata(region_factor)  distribution(weibull) time    
estimates store WBConsStrata3
//estimates save "C:\Onedrive\Research\Telephone\Code\Stata\Results\WBConsStrata.csv", replace
//estimates save \\Client\C$\Onedrive\Research\Telephone\Code\Stata\Results\WBConsStrata.csv, replace


//quietly 
streg  ma_pop_in_1880 border y1880 postrevenues_pc telegraphrevenues_pc agriculture empratio82 indexdissim82 statetax railstation railrevenues participation socialist zentrum difcatholicszentrum city popshare1880 fringe,  vce(robust) strata(region_factor)  distribution(weibull) time    
estimates store WBConsStrata4

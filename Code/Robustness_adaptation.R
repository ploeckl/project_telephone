...
SpatMatrix1905<-mat2listw(MatInvDist) 
...
SpatMatrix1900<-mat2listw(MatInvDist[Towns$Lines1900>0,Towns$Lines1900>0]) 
...
SpatMatrix1905small<-mat2listw(MatInvDist[Towns$Lines1900>0,Towns$Lines1900>0]) #make sure it fits
